        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dispositivos_Clientes_IdCliente",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescripcionFalla = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdenesServicio_Dispositivos_IdDispositivo",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesRepuesto", x => x.IdDetalle);
                    table.ForeignKey(
                        name: "FK_DetallesRepuesto_OrdenesServicio_IdOrden",
                        column: x => x.IdOrden,
                        principalTable: "OrdenesServicio",
                        principalColumn: "IdOrden",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallesRepuesto_Repuestos_IdRepuesto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesRepuesto_IdOrden",
                table: "DetallesRepuesto",
                column: "IdOrden");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesRepuesto_IdRepuesto",
                table: "DetallesRepuesto",
                column: "IdRepuesto");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_IdCliente",
                table: "Dispositivos",
                column: "IdCliente");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdenesServicio_IdDispositivo",
                table: "OrdenesServicio",
